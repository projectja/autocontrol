...
class AutocontrolRoutes {
    ...
    config() {
        ...
        this.router.get('/', autocontrolController_1.default.zonalist);
        // solor obtener una rruta
        this.router.get('/:id', autocontrolController_1.default.zonagetOne);
        // la ruta es la misma pero a traves del metodo POST:
        this.router.post('/', autocontrolController_1.default.zonacreate);
        this.router.delete('/:id', autocontrolController_1.default.zonadelete);
        this.router.put('/:id', autocontrolController_1.default.zonaupdate);
    }
}
